...
const Services = () => {
  return (
    <motion.div
      ...
      id='services' className='w-full px-[12%] py-16 scroll-mt-20 '>
      <motion.h4
      ...
      <motion.div
        ...
        {serviceData.map(({ icon, title, description, link }, index) => (
          <motion.div
            ...
            key={index}
            className='border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 h-90 dark:hover:bg-darkhover dark:hover:shadow-white'>
