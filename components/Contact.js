...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "b11fbc51-de91-4ab9-990d-705303400c36");
    ...
    transition={{duration:0.5,delay:0.7}}
            className='text-center max-w-2xl mx-auto mt-5 mb-12 py-5 font-Ovo'>
                I would love to hear from you! If you have any questions, comments, or feedback, please use the form bellow.
            </motion.p>
    ...
    transition={{duration:0.6,delay:1.3}}
                ...
                type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 cursor-pointer dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkhover'>Submit Now <Image src={assets.right_arrow_white} alt='' className='w-4 ' /> </motion.button>
